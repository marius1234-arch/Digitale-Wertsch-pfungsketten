...
def erstelle_datenbank(db_pfad: str) -> None:
    ...
    # Dies sind die exakten Werte der Projekt-Datenbank, fest hinterlegt, damit der
    # Fallback (z. B. auf Streamlit Cloud, wenn die .db-Datei nicht gefunden wird)
    # dieselben Zahlen liefert wie die lokale Datenbank — kein Zufallsgenerator.
    cur.executemany(
